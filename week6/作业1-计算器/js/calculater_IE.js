...
mydiv.attachEvent("onclick", function() {
    var get = window.event.srcElement.value;
...
plus.attachEvent("onclick", function() {
...
minus.attachEvent("onclick", function() {
...
times.attachEvent("onclick", function() {
...
divide.attachEvent("onclick", function() {
...
percentage.attachEvent("onclick", function() {
...
sqrt.attachEvent("onclick", function() {
...
sin.attachEvent("onclick", function() {
...
cos.attachEvent("onclick", function() {
...
pi.attachEvent("onclick", function() {
...
negative.attachEvent("onclick", function() {
...
equal.attachEvent("onclick", function() {
    ...
    getString = outcome; //将结果储存在getString中，在下一次运算中作为第一个运算数使用
    first = ""; //清空第一个运算数
    second = ""; //清空第二个运算数
    operater = ""; //清空运算符
});
